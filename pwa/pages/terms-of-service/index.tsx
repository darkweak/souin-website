...
const ToS: NextPage = () => (
  <>
    ...
    <article className="max-w-full prose md:prose-xl pt-8">
      ...
      <p>
        All content published and made available on this site is the property of Sylvain COMBRAQUE and its creators.
        That includes, but is not limited to images, text, logos, documents, downloadable files and anything else that
      ...
      <p>
        ...
        cannot guarantee the accuracy of every product or service we provide. You agree to purchase these services at
        your own risk.
      </p>
      <h2>Payments</h2>
      ...
      <h3>Subscriptions</h3>
      <p>
        All of our recurring subscriptions will be automatically billed and renewed until we receive notice that you
      ...
      <p>
        ...
        Nevertheless, Sylvain COMBRAQUE and his employees will not be held responsible for any problem resulting from
        any irregular use of this site.
      </p>
      <h2>Indemnity</h2>
      <p>
        As a user, you hereby indemnify Sylvain COMBRAQUE from any and all liability, costs, causes of action, damages
        or expenses arising out of your use of this site or your breach of any of the provisions set out in this
        document.
      </p>
      ...
      <h2>Divisibility</h2>
      <p>
        If at any time any of the provisions set forth herein are held to be inconsistent or invalid under applicable
        law, such provisions shall be deemed void and shall be severed from this document. All other provisions will not
        be affected by law and the rest of the document will still be considered valid.
      </p>
      <h2>Amendments</h2>
      <p>
        These terms and conditions may be amended from time to time to maintain compliance with the law and to reflect
        any changes to the way we run our site and the way we expect users to behave on our site. We recommend that our
        users check these terms and conditions from time to time to ensure that they are aware of any updates. If
        necessary, we will notify users by email of changes to these terms or we will post a notice on our site.
      </p>
      <h2>Contact</h2>
